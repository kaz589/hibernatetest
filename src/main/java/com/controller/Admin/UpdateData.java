...
//		System.out.println(password_Hashing);
		...
		Member member_ans = member.update(member_id,full_name,username,password_Hashing,email,total_miles,phone_number,registration_date,email_verified,phone_verified,membership_level);

			
			request.setAttribute("member", member_ans);

			request.getRequestDispatcher("/admin/UpdateDataResult.jsp").forward(request, response);
		} 
